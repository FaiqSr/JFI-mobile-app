...
export interface QcApprovePayload {
...
export interface RingRequest {
  ...
  notedJobdesc?: string | null;
  materialNoted?: string | null;
  soNo: string;
  materialType: string;
  productName: string;
  size: string;
  ...
  notedSizeOdId?: string | null;
  timeStart: string;
  timeEnd: string;
  gantiOrderA?: number | null;
  repairB?: number | null;
  materialTungguC?: number | null;
  operatorD?: number | null;
  maintenanceE?: number | null;
  checkingF?: number | null;
  finishGoodFG?: number | null;
  timeNote?: string | null;
}

export interface RingDuaRequest extends RingRequest {

}

export interface RingTigaRequest extends RingRequest {
  soNo: string;
}

export interface DjgRequest {
  productName: string;
  soNo: string;
  jobDescription: string;
  typeProduct: string;
